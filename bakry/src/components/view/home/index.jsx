    ...
    <>
      <div className="w-full h-[850px] bg-cover bg-center bg-[url('/assets/images/hero-section-bg.svg')] relative">
        <div className="container">
          ...
          <img className='hidden lg:block lg:absolute right-[80px]' src="/assets/images/hero-section-img1.svg"
            alt="Cookie-img" />
        ...
        <img className='hidden lg:block absolute left-[300px]' src="/assets/images/hero-section-img2.svg"
          alt="cookie-img" />
      </div>
      <div className="container">
